              ...
              <div className="lg:px-6 pt-4 lg:pl-40 lg:pr-40 md:pl-5 md:pr-5 flex-grow scrollbar-hide w-full max-h-full pb-0">
                ...
                <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6 mb-6">
                  ...
                  <div className="sm:col-span-4">
                    <SwitchToggle
                      id="free_shipping"
                      processOption={enabledFreeShipping}
                      handleProcess={setEnabledFreeShipping}
                    />
                  </div>
                </div>
                ...
                <div
                  style={{
                    height: enabledFreeShipping ? "auto" : 0,
                    transition: "all .6s",
                    visibility: !enabledFreeShipping ? "hidden" : "visible",
                    opacity: !enabledFreeShipping ? "0" : "1",
                  }}
                  className={`${enabledFreeShipping ? "mb-6" : "mb-2"}`}
                >
                  <div className="grid md:grid-cols-5 items-center sm:grid-cols-12 gap-3 md:gap-5 xl:gap-6 lg:gap-6">
                    <label className="block md:text-sm md:col-span-1 sm:col-span-2 text-xs font-semibold text-gray-600 dark:text-gray-400 mb-1">
                      {t("FreeShippingThreshold")} <br />
                      <span className="text-xs font-normal text-gray-600 dark:text-gray-400">
                    ...
                    <div className="sm:col-span-4">
                      ...
                      />
                      <Error errorName={errors.free_shipping_threshold} />
                    </div>
                  </div>
                </div>
