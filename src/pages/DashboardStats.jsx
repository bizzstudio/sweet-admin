/*
 * מסך נתוני המכירות — זה היה תוכן "לוח הבקרה" עד לשינוי לתפריט כפתורים.
 * לוח הבקרה (/dashboard) הפך למסך ניווט, והתוכן הזה עבר לכאן (/dashboard-stats)
 * ונשמר במלואו. נכנסים אליו מהכפתור "נתוני מכירות" בלוח הבקרה.
 */
import {
  Card,
  CardBody,
              ...
              <div className="overflow-x-auto -mx-2 sm:mx-0">
                <TableContainer className="min-w-[280px]">
                  <Table className="w-full whitespace-nowrap admin-table">
                    <TableHeader>
                      <tr>
                        <TableHeaderCell className="text-center text-sm sm:text-base py-2 sm:py-3 px-2 sm:px-4">{t("ProductName")}</TableHeaderCell>
                        {productSalesList.some((r) => r.unit) && (
                          <TableHeaderCell className="text-center text-sm sm:text-base py-2 sm:py-3 px-2 sm:px-4">{t("Unit")}</TableHeaderCell>
                        )}
                        <TableHeaderCell className="text-center text-sm sm:text-base py-2 sm:py-3 px-2 sm:px-4">{t("QuantitySold")}</TableHeaderCell>
                      </tr>
                    </TableHeader>
          ...
          <Table className="w-full whitespace-nowrap admin-table">
            <TableHeader>
              <tr>
                ...
                <TableHeaderCell className="text-center">{t("TimeTbl")}</TableHeaderCell>
                <TableHeaderCell className="text-center">{t("CustomerName")}</TableHeaderCell>
                <TableHeaderCell className="text-center">{t("MethodTbl")}</TableHeaderCell>
                ...
                <TableHeaderCell className="text-center">{t("InvoiceTbl")}</TableHeaderCell>
              </tr>
            </TableHeader>
